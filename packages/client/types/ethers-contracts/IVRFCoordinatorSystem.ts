...
export interface IVRFCoordinatorSystemInterface extends utils.Interface {
  functions: {
...
export interface IVRFCoordinatorSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IVRFCoordinatorSystemInterface;
