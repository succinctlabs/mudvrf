...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("VRFRequestNonce")));
bytes32 constant VRFRequestNonceTableId = _tableId;

library VRFRequestNonce {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("VRFRequestNonce", _fieldNames);
  }
